...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.flutter_z_location.FlutterZLocationPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_z_location, com.example.flutter_z_location.FlutterZLocationPlugin", e);
    }
    try {
